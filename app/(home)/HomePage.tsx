...
export default function HomePage({ numStars }: { numStars: string }) {
  ...
  const cardItems = [
    {
      title: "IDEM",
      description: "Immersive Digital Experience Management Platform",
      footer: "Digital space for immersive and personalized customer experiences",
  ...
  return (
    <div className="container mx-auto p-4 max-w-7xl">
      ...
      <div className="space-y-4 text-center">
        ...
        >
          Immersive Digital Experience Management
        </h1>
        <h2 className="text-2xl font-medium">
          Digital space for immersive and personalized immersive customer experiences
        </h2>
